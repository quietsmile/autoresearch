...
class GPT(nn.Module):
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        param_groups = [
            ...
            dict(kind='adamw', params=resid_params, lr=scalar_lr * 0.006, betas=adam_betas, eps=1e-10, weight_decay=0.0),
...
# Optimization
TOTAL_BATCH_SIZE = 2**18 # ~262K tokens per optimizer step (more steps with DEPTH=10)
EMBEDDING_LR = 0.65     # learning rate for token embeddings (Adam)
UNEMBEDDING_LR = 0.004  # learning rate for lm_head (Adam)
MATRIX_LR = 0.04        # learning rate for matrix parameters (Muon)
SCALAR_LR = 0.5         # learning rate for per-layer scalars (Adam)
WEIGHT_DECAY = 0.2      # cautious weight decay for Muon
ADAM_BETAS = (0.84, 0.95) # Adam beta1, beta2
...
# Model size
DEPTH = 9               # number of transformer layers (same n_embd=640, fewer layers → more steps)

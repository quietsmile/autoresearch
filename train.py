...
class GPT(nn.Module):
    ...
    def _compute_window_sizes(self, config):
        ...
        med_window = long_window // 2  # medium window: 1024 tokens
        char_to_window = {"L": (long_window, 0), "S": (short_window, 0), "M": (med_window, 0)}
        window_sizes = []
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        param_groups = [
            ...
            dict(kind='adamw', params=x0_params, lr=scalar_lr, betas=adam_betas, eps=1e-10, weight_decay=0.0),
        ]
...
# Optimization
TOTAL_BATCH_SIZE = 2**18 # ~262K tokens per step (no grad accum, more steps)
...
ADAM_BETAS = (0.83, 0.9) # Adam beta1, beta2
